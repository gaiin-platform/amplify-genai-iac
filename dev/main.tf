...
module "ecs" {
  ...
  secret_access_policy_name        = "${var.secret_access_policy_name}"
  container_exec_policy_name       = "${var.container_exec_policy_name}"
  container_port                   = var.container_port
  task_name                        = "${var.task_name}"
  task_role_name                   = "${var.task_role_name}"
  task_execution_role_name         = "${var.task_execution_role_name}"
  container_name                   = "${var.container_name}"
  ecr_repo_access_policy_name      = "${var.ecr_repo_access_policy_name}"
  ...
  envs_name                        = "${var.envs_name}"
  ecs_scale_down_alarm_description = "${var.ecs_scale_down_alarm_description}"
  ecs_scale_up_alarm_description   = "${var.ecs_scale_up_alarm_description}"
